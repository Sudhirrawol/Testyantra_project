...
import bgImg from "../assets/contentimages/indusrty_health.jpg";
        ...
        <div>
          ...
          <aside className={st.TextCon}>
            ...
            <div className={st.BottomText}>
              <p>
                We use technologies like hybrid cloud, DA and AI to provide
                solutions to our healthcare clients
              </p>
            </div>
          </aside>
        </div>
